...
class Checkout {
    ...
    bindProductList(products) {
        ...
        for (let item of this.cart.items) {
            ...
            productItem = productItem.replace(/{productID}/g, item.productId);
            productItem = productItem.replace('{productPrice}', '$' + item[priceType]);
            productItem = productItem.replace('{productQuantity}', item.quantity);
