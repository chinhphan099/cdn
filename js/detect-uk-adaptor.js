        ...
        tabs.forEach((tabItem) => {
            tabItem.addEventListener('click', (e) => {
                ...
                if (type.toLowerCase().trim() === 'uk') {
                    ...
                    _q('.devider-paypal').classList.add('hidden');
                    _q('#js-paypal-oneclick-button').classList.add('hidden');
                    ...
                    _q('.devider-paypal').classList.remove('hidden');
                    _q('#js-paypal-oneclick-button').classList.remove('hidden');
